...
/**
 * @brief hal_platform_print_system_info Provides important system information
 *
 * The provided characteristics contain:
 * - The current system time
 * - The allocated memory
 * - The remaining free memory
 * - The memory in the pool
 *
 * The information is provided  as String via the debug interface
 * from hal_debug.h
 */
...
/**
 * @brief hal_platform_hard_restart_upcn Restarts the application in a hard way,
 *					 i.e. takes no regard to current work
 */
