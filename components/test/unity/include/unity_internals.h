...
// NOTE: Edited by Felix W. for compatibility of TEST_ASSERT_NULL
//       with static analyzers (clang-check, ...)
#define UNITY_TEST_ASSERT(condition, line, message)                                              if (condition) {} else {UNITY_TEST_FAIL((UNITY_LINE_TYPE)line, message); for(;;);}
