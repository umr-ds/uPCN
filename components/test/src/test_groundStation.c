...
TEST_SETUP(groundStation)
{
	...
	mini_snprintf(e1, 9, "testeid1");
	mini_snprintf(e2, 9, "testeid2");
	mini_snprintf(e3, 9, "testeid2");
	mini_snprintf(e4, 9, "testeid3");
	e1 = eidmanager_alloc_ref(e1, 1);
	e2 = eidmanager_alloc_ref(e2, 1);
	e3 = eidmanager_alloc_ref(e3, 1);
	e4 = eidmanager_alloc_ref(e4, 1);
...
TEST(groundStation, endpoint_list_union)
{
	some_eids1 = endpoint_list_union(some_eids1, some_eids2, 0);
	some_eids2 = NULL;
...
TEST(groundStation, endpoint_list_difference)
{
...
TEST(groundStation, contact_list_union)
{
...
TEST(groundStation, contact_list_difference)
{
	struct contact_list *mod = NULL;
...
TEST(groundStation, add_contact_to_ordered_list)
{
...
TEST_GROUP_RUNNER(groundStation)
{
	RUN_TEST_CASE(groundStation, contact);
	RUN_TEST_CASE(groundStation, endpoint_list_difference);
	RUN_TEST_CASE(groundStation, endpoint_list_union);
	RUN_TEST_CASE(groundStation, contact_list_union);
	RUN_TEST_CASE(groundStation, contact_list_difference);
	RUN_TEST_CASE(groundStation, add_contact_to_ordered_list);
}
