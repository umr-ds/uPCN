 ...
 *
 * Thus, no further components of uPCN can use the communication interface again.
 */
 ...
 * @brief cla_lock_com_tx_semaphore Unlock the communication semaphore.
 *
 * Thus, no further other components of uPCN can use the communication interface again.
 */
 ...
 * @param length The length of the payload data of this function call (in bytes).
 */
