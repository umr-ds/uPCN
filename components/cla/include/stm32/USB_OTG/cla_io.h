 ...
 *
 * Thus, no further component of uPCN can use the communication interface.
 */
 ...
 * @return Specifies if the read operation was successful.
 */
 ...
 *
 * The user has to assert that the current buffer is large enough to contain
 * "length" bytes.
 *
