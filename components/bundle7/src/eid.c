...
uint8_t *bundle7_eid_serialize_alloc(const char *eid, size_t *length)
{
	...
	uint8_t *buffer = bundle7_malloc(buffer_size);
	...
	uint8_t *compress = bundle7_realloc(buffer, written);
